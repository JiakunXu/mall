...
import com.kintiger.mall.cache.service.impl.MemcachedCacheServiceImpl;
import com.kintiger.mall.framework.log.Logger4jCollection;
import com.kintiger.mall.framework.log.Logger4jExtend;
import com.kintiger.mall.framework.util.PropertiesUtil;
...
public class SessionFilter implements Filter {
	...
	public void doFilter(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
		...
		try {
			...
			if (StringUtils.isNotBlank(requestSessionId)) {
		...
		try {
			...
			if (session != null) {
				...
				if (StringUtils.isNotBlank(sessionId)) {
					...
					if (!sessionId.equals(requestSessionId) && StringUtils.isNotBlank(requestSessionId)) {
